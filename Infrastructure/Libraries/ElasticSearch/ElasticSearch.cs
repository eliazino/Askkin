...
namespace Infrastructure.Libraries.ElasticSearch {
    public class ElasticSearch : IElasticSearch {
        private readonly Core.Model.DTO.Configuration.ElasticSearch _config;
        ...
        public ElasticSearch(Core.Model.DTO.Configuration.ElasticSearch config) {
            _config = config;
            _init();
        }
